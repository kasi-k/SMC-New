...
// Reusable InputField, SelectField, RadioButtonGroup (same as AddPackage)
const InputField = ({
  label,
  register,
  name,
...
const EditPackage = () => {
  ...
  return (
    <div className="mx-6 my-8 font-poppins h-full">
      <p className="mb-2">Edit Package</p>
      <form onSubmit={handleSubmit(onSubmit)} className="mx-4 my-6">
        ...
        <div className="flex items-center gap-4">
          <button
            type="submit"
            className={`my-6 text-white bg-gradient-to-r from-[#3D03FA] to-[#A71CD2] px-8 py-1.5 rounded-md ${
